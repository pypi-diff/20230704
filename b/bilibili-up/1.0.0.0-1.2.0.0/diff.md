# Comparing `tmp/bilibili_up-1.0.0.0.tar.gz` & `tmp/bilibili_up-1.2.0.0.tar.gz`
...
## Comparing `bilibili_up-1.0.0.0.tar` & `bilibili_up-1.2.0.0.tar`
...
### Comparing `bilibili_up-1.0.0.0/PKG-INFO` & `bilibili_up-1.2.0.0/README.md`
...
### Comparing `bilibili_up-1.0.0.0/bilibili_up/BV.py` & `bilibili_up-1.2.0.0/bilibili_up/BV.py`
...
### Comparing `bilibili_up-1.0.0.0/setup.py` & `bilibili_up-1.2.0.0/setup.py`
