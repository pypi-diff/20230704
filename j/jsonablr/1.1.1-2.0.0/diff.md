# Comparing `tmp/jsonablr-1.1.1.tar.gz` & `tmp/jsonablr-2.0.0.tar.gz`
...
## Comparing `jsonablr-1.1.1.tar` & `jsonablr-2.0.0.tar`
...
### Comparing `jsonablr-1.1.1/LICENSE` & `jsonablr-2.0.0/LICENSE`

 * *Files identical despite different names*

### Comparing `jsonablr-1.1.1/README.md` & `jsonablr-2.0.0/README.md`
...
### Comparing `jsonablr-1.1.1/jsonablr/main.py` & `jsonablr-2.0.0/jsonablr/main.py`
...
### Comparing `jsonablr-1.1.1/pyproject.toml` & `jsonablr-2.0.0/pyproject.toml`
...
### Comparing `jsonablr-1.1.1/PKG-INFO` & `jsonablr-2.0.0/PKG-INFO`
