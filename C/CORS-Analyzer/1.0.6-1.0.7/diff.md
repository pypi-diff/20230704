# Comparing `tmp/CORS-Analyzer-1.0.6.tar.gz` & `tmp/CORS-Analyzer-1.0.7.tar.gz`
...
## Comparing `CORS-Analyzer-1.0.6.tar` & `CORS-Analyzer-1.0.7.tar`
...
### Comparing `CORS-Analyzer-1.0.6/CORS_Analyzer.egg-info/PKG-INFO` & `CORS-Analyzer-1.0.7/CORS_Analyzer.egg-info/PKG-INFO`
...
### Comparing `CORS-Analyzer-1.0.6/PKG-INFO` & `CORS-Analyzer-1.0.7/PKG-INFO`
...
### Comparing `CORS-Analyzer-1.0.6/README.md` & `CORS-Analyzer-1.0.7/README.md`

 * *Files identical despite different names*

### Comparing `CORS-Analyzer-1.0.6/lib/cors.py` & `CORS-Analyzer-1.0.7/lib/cors.py`
...
### Comparing `CORS-Analyzer-1.0.6/setup.py` & `CORS-Analyzer-1.0.7/setup.py`
