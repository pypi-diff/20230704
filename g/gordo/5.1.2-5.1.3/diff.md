# Comparing `tmp/gordo-5.1.2.tar.gz` & `tmp/gordo-5.1.3.tar.gz`
...
### Comparing `gordo-5.1.2/.github/workflows/main.yml` & `gordo-5.1.3/.github/workflows/main.yml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/.github/workflows/master-ci.yml` & `gordo-5.1.3/.github/workflows/master-ci.yml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/.github/workflows/release.yml` & `gordo-5.1.3/.github/workflows/release.yml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/.gitignore` & `gordo-5.1.3/.gitignore`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/Dockerfile` & `gordo-5.1.3/Dockerfile`
...
### Comparing `gordo-5.1.2/LICENSE` & `gordo-5.1.3/LICENSE`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/Makefile` & `gordo-5.1.3/Makefile`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/PKG-INFO` & `gordo-5.1.3/PKG-INFO`
...
### Comparing `gordo-5.1.2/README.md` & `gordo-5.1.3/README.md`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/benchmarks/load_test/README.md` & `gordo-5.1.3/benchmarks/load_test/README.md`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/benchmarks/load_test/load_test.py` & `gordo-5.1.3/benchmarks/load_test/load_test.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/benchmarks/test_ml_server.py` & `gordo-5.1.3/benchmarks/test_ml_server.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/docs/Makefile` & `gordo-5.1.3/docs/Makefile`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/docs/_static/Gordo_C4.svg` & `gordo-5.1.3/docs/_static/Gordo_C4.svg`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/docs/_static/architecture_diagram.png` & `gordo-5.1.3/docs/_static/architecture_diagram.png`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/docs/_static/architecture_diagram.py` & `gordo-5.1.3/docs/_static/architecture_diagram.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/docs/_static/argo_logo.png` & `gordo-5.1.3/docs/_static/argo_logo.png`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/docs/_static/endpoint-metadata.png` & `gordo-5.1.3/docs/_static/endpoint-metadata.png`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/docs/api/builder.rst` & `gordo-5.1.3/docs/api/builder.rst`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/docs/api/cli.rst` & `gordo-5.1.3/docs/api/cli.rst`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/docs/api/machine/metadata.rst` & `gordo-5.1.3/docs/api/machine/metadata.rst`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/docs/api/machine/model/anomaly.rst` & `gordo-5.1.3/docs/api/machine/model/anomaly.rst`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/docs/api/machine/model/model-factories.rst` & `gordo-5.1.3/docs/api/machine/model/model-factories.rst`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/docs/api/serializer.rst` & `gordo-5.1.3/docs/api/serializer.rst`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/docs/api/util.rst` & `gordo-5.1.3/docs/api/util.rst`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/docs/api/workflow.rst` & `gordo-5.1.3/docs/api/workflow.rst`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/docs/conf.py` & `gordo-5.1.3/docs/conf.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/docs/general/cluster_deployment.rst` & `gordo-5.1.3/docs/general/cluster_deployment.rst`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/docs/general/endpoints.rst` & `gordo-5.1.3/docs/general/endpoints.rst`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/docs/ml/model_configuration.rst` & `gordo-5.1.3/docs/ml/model_configuration.rst`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/docs/ml/model_output.rst` & `gordo-5.1.3/docs/ml/model_output.rst`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/docs/overview.rst` & `gordo-5.1.3/docs/overview.rst`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/examples/Gordo-Workflow-High-Level.ipynb` & `gordo-5.1.3/examples/Gordo-Workflow-High-Level.ipynb`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/examples/Pipelines-with-Gordo.ipynb` & `gordo-5.1.3/examples/Pipelines-with-Gordo.ipynb`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/examples/config.yaml` & `gordo-5.1.3/examples/config.yaml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/examples/model-configuration.yaml` & `gordo-5.1.3/examples/model-configuration.yaml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/examples/test-project.yaml` & `gordo-5.1.3/examples/test-project.yaml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/functions.sh` & `gordo-5.1.3/functions.sh`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/__init__.py` & `gordo-5.1.3/gordo/__init__.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/builder/build_model.py` & `gordo-5.1.3/gordo/builder/build_model.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/builder/local_build.py` & `gordo-5.1.3/gordo/builder/local_build.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/builder/utils.py` & `gordo-5.1.3/gordo/builder/utils.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/cli/cli.py` & `gordo-5.1.3/gordo/cli/cli.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/cli/custom_types.py` & `gordo-5.1.3/gordo/cli/custom_types.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/cli/exceptions_reporter.py` & `gordo-5.1.3/gordo/cli/exceptions_reporter.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/cli/workflow_generator.py` & `gordo-5.1.3/gordo/cli/workflow_generator.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/machine/encoders.py` & `gordo-5.1.3/gordo/machine/encoders.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/machine/loader.py` & `gordo-5.1.3/gordo/machine/loader.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/machine/machine.py` & `gordo-5.1.3/gordo/machine/machine.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/machine/metadata/metadata.py` & `gordo-5.1.3/gordo/machine/metadata/metadata.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/machine/model/anomaly/base.py` & `gordo-5.1.3/gordo/machine/model/anomaly/base.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/machine/model/anomaly/diff.py` & `gordo-5.1.3/gordo/machine/model/anomaly/diff.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/machine/model/base.py` & `gordo-5.1.3/gordo/machine/model/base.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/machine/model/factories/feedforward_autoencoder.py` & `gordo-5.1.3/gordo/machine/model/factories/feedforward_autoencoder.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/machine/model/factories/lstm_autoencoder.py` & `gordo-5.1.3/gordo/machine/model/factories/lstm_autoencoder.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/machine/model/factories/utils.py` & `gordo-5.1.3/gordo/machine/model/factories/utils.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/machine/model/models.py` & `gordo-5.1.3/gordo/machine/model/models.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/machine/model/register.py` & `gordo-5.1.3/gordo/machine/model/register.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/machine/model/transformer_funcs/general.py` & `gordo-5.1.3/gordo/machine/model/transformer_funcs/general.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/machine/model/transformers/imputer.py` & `gordo-5.1.3/gordo/machine/model/transformers/imputer.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/machine/model/utils.py` & `gordo-5.1.3/gordo/machine/model/utils.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/machine/validators.py` & `gordo-5.1.3/gordo/machine/validators.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/reporters/base.py` & `gordo-5.1.3/gordo/reporters/base.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/reporters/mlflow.py` & `gordo-5.1.3/gordo/reporters/mlflow.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/reporters/postgres.py` & `gordo-5.1.3/gordo/reporters/postgres.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/serializer/from_definition.py` & `gordo-5.1.3/gordo/serializer/from_definition.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/serializer/into_definition.py` & `gordo-5.1.3/gordo/serializer/into_definition.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/serializer/serializer.py` & `gordo-5.1.3/gordo/serializer/serializer.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/serializer/utils.py` & `gordo-5.1.3/gordo/serializer/utils.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/server/blueprints/anomaly.py` & `gordo-5.1.3/gordo/server/blueprints/anomaly.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/server/blueprints/base.py` & `gordo-5.1.3/gordo/server/blueprints/base.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/server/model_io.py` & `gordo-5.1.3/gordo/server/model_io.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/server/prometheus/metrics.py` & `gordo-5.1.3/gordo/server/prometheus/metrics.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/server/prometheus/server.py` & `gordo-5.1.3/gordo/server/prometheus/server.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/server/properties.py` & `gordo-5.1.3/gordo/server/properties.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/server/server.py` & `gordo-5.1.3/gordo/server/server.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/server/utils.py` & `gordo-5.1.3/gordo/server/utils.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/util/disk_registry.py` & `gordo-5.1.3/gordo/util/disk_registry.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/util/utils.py` & `gordo-5.1.3/gordo/util/utils.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/util/version.py` & `gordo-5.1.3/gordo/util/version.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/utils.py` & `gordo-5.1.3/gordo/utils.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/workflow/config_elements/normalized_config.py` & `gordo-5.1.3/gordo/workflow/config_elements/normalized_config.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/workflow/config_elements/schemas.py` & `gordo-5.1.3/gordo/workflow/config_elements/schemas.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/workflow/workflow_generator/helpers.py` & `gordo-5.1.3/gordo/workflow/workflow_generator/helpers.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/workflow/workflow_generator/resources/argo-workflow.yml.template` & `gordo-5.1.3/gordo/workflow/workflow_generator/resources/argo-workflow.yml.template`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo/workflow/workflow_generator/workflow_generator.py` & `gordo-5.1.3/gordo/workflow/workflow_generator/workflow_generator.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo.egg-info/PKG-INFO` & `gordo-5.1.3/gordo.egg-info/PKG-INFO`
...
### Comparing `gordo-5.1.2/gordo.egg-info/SOURCES.txt` & `gordo-5.1.3/gordo.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/gordo.egg-info/requires.txt` & `gordo-5.1.3/gordo.egg-info/requires.txt`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/pytest.ini` & `gordo-5.1.3/pytest.ini`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/requirements/full_requirements.txt` & `gordo-5.1.3/requirements/full_requirements.txt`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/requirements/test_requirements.txt` & `gordo-5.1.3/requirements/test_requirements.txt`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/resources/grafana/dashboards/Gordo_servers-VictoriaMetrics.json` & `gordo-5.1.3/resources/grafana/dashboards/Gordo_servers-VictoriaMetrics.json`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/resources/grafana/dashboards/machines.json` & `gordo-5.1.3/resources/grafana/dashboards/machines.json`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/run_workflow_and_argo.sh` & `gordo-5.1.3/run_workflow_and_argo.sh`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/scripts/download_argo.py` & `gordo-5.1.3/scripts/download_argo.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/scripts/github_docker.py` & `gordo-5.1.3/scripts/github_docker.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/scripts/tests.sh` & `gordo-5.1.3/scripts/tests.sh`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/scripts/trivy_scan.sh` & `gordo-5.1.3/scripts/trivy_scan.sh`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/setup.py` & `gordo-5.1.3/setup.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/config-test.yaml` & `gordo-5.1.3/tests/config-test.yaml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/conftest.py` & `gordo-5.1.3/tests/conftest.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/builder/test_builder.py` & `gordo-5.1.3/tests/gordo/builder/test_builder.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/builder/test_local_build.py` & `gordo-5.1.3/tests/gordo/builder/test_local_build.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/builder/test_utils.py` & `gordo-5.1.3/tests/gordo/builder/test_utils.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/cli/test_cli.py` & `gordo-5.1.3/tests/gordo/cli/test_cli.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/cli/test_exception_reporter.py` & `gordo-5.1.3/tests/gordo/cli/test_exception_reporter.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/client/test_client.py` & `gordo-5.1.3/tests/gordo/client/test_client.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/machine/metadata/test_metadata.py` & `gordo-5.1.3/tests/gordo/machine/metadata/test_metadata.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/machine/model/anomaly/test_anomaly_detectors.py` & `gordo-5.1.3/tests/gordo/machine/model/anomaly/test_anomaly_detectors.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/machine/model/test_factories_utils.py` & `gordo-5.1.3/tests/gordo/machine/model/test_factories_utils.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/machine/model/test_feedforward_autoencoder.py` & `gordo-5.1.3/tests/gordo/machine/model/test_feedforward_autoencoder.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/machine/model/test_lstm_autoencoder.py` & `gordo-5.1.3/tests/gordo/machine/model/test_lstm_autoencoder.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/machine/model/test_model.py` & `gordo-5.1.3/tests/gordo/machine/model/test_model.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/machine/model/test_raw_keras.py` & `gordo-5.1.3/tests/gordo/machine/model/test_raw_keras.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/machine/model/test_register.py` & `gordo-5.1.3/tests/gordo/machine/model/test_register.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/machine/model/test_transformers.py` & `gordo-5.1.3/tests/gordo/machine/model/test_transformers.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/machine/model/test_utils.py` & `gordo-5.1.3/tests/gordo/machine/model/test_utils.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/machine/test_descriptors.py` & `gordo-5.1.3/tests/gordo/machine/test_descriptors.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/machine/test_loader.py` & `gordo-5.1.3/tests/gordo/machine/test_loader.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/machine/test_machine.py` & `gordo-5.1.3/tests/gordo/machine/test_machine.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/reporters/test_mlflow_reporter.py` & `gordo-5.1.3/tests/gordo/reporters/test_mlflow_reporter.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/reporters/test_postgres_reporter.py` & `gordo-5.1.3/tests/gordo/reporters/test_postgres_reporter.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/serializer/test_serializer_from_definition.py` & `gordo-5.1.3/tests/gordo/serializer/test_serializer_from_definition.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/serializer/test_serializer_into_definition.py` & `gordo-5.1.3/tests/gordo/serializer/test_serializer_into_definition.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/serializer/test_serializer_load_dump.py` & `gordo-5.1.3/tests/gordo/serializer/test_serializer_load_dump.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/server/test_anomaly_blueprint.py` & `gordo-5.1.3/tests/gordo/server/test_anomaly_blueprint.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/server/test_base_blueprint.py` & `gordo-5.1.3/tests/gordo/server/test_base_blueprint.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/server/test_gordo_server.py` & `gordo-5.1.3/tests/gordo/server/test_gordo_server.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/server/test_model_io.py` & `gordo-5.1.3/tests/gordo/server/test_model_io.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/server/test_prometheus.py` & `gordo-5.1.3/tests/gordo/server/test_prometheus.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/server/test_utils.py` & `gordo-5.1.3/tests/gordo/server/test_utils.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/test_version.py` & `gordo-5.1.3/tests/gordo/test_version.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/util/test_disk_registry.py` & `gordo-5.1.3/tests/gordo/util/test_disk_registry.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/util/test_version.py` & `gordo-5.1.3/tests/gordo/util/test_version.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/workflow/test_config_elements.py` & `gordo-5.1.3/tests/gordo/workflow/test_config_elements.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/workflow/test_helpers.py` & `gordo-5.1.3/tests/gordo/workflow/test_helpers.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/workflow/test_normalized_config.py` & `gordo-5.1.3/tests/gordo/workflow/test_normalized_config.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/workflow/test_workflow_generator/data/config-test-allowed-timestamps.yml` & `gordo-5.1.3/tests/gordo/workflow/test_workflow_generator/data/config-test-allowed-timestamps.yml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/workflow/test_workflow_generator/data/config-test-datasource.yml` & `gordo-5.1.3/tests/gordo/workflow/test_workflow_generator/data/config-test-datasource.yml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/workflow/test_workflow_generator/data/config-test-disable-influx.yml` & `gordo-5.1.3/tests/gordo/workflow/test_workflow_generator/data/config-test-disable-influx.yml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/workflow/test_workflow_generator/data/config-test-empty-tag-list.yml` & `gordo-5.1.3/tests/gordo/workflow/test_workflow_generator/data/config-test-empty-tag-list.yml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/workflow/test_workflow_generator/data/config-test-failing-resource-format.yml` & `gordo-5.1.3/tests/gordo/workflow/test_workflow_generator/data/config-test-failing-resource-format.yml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/workflow/test_workflow_generator/data/config-test-model-builder-spec.yaml` & `gordo-5.1.3/tests/gordo/workflow/test_workflow_generator/data/config-test-model-builder-spec.yaml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/workflow/test_workflow_generator/data/config-test-quotes.yml` & `gordo-5.1.3/tests/gordo/workflow/test_workflow_generator/data/config-test-quotes.yml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/workflow/test_workflow_generator/data/config-test-runtime-images.yaml` & `gordo-5.1.3/tests/gordo/workflow/test_workflow_generator/data/config-test-runtime-images.yaml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/workflow/test_workflow_generator/data/config-test-runtime-labels.yaml` & `gordo-5.1.3/tests/gordo/workflow/test_workflow_generator/data/config-test-runtime-labels.yaml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/workflow/test_workflow_generator/data/config-test-runtime-resource.yaml` & `gordo-5.1.3/tests/gordo/workflow/test_workflow_generator/data/config-test-runtime-resource.yaml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/workflow/test_workflow_generator/data/config-test-selective-influx.yml` & `gordo-5.1.3/tests/gordo/workflow/test_workflow_generator/data/config-test-selective-influx.yml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/workflow/test_workflow_generator/data/config-test-timestamp-1.yml` & `gordo-5.1.3/tests/gordo/workflow/test_workflow_generator/data/config-test-timestamp-1.yml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/workflow/test_workflow_generator/data/config-test-timestamp-2.yml` & `gordo-5.1.3/tests/gordo/workflow/test_workflow_generator/data/config-test-timestamp-2.yml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/workflow/test_workflow_generator/data/config-test-timestamp-3.yml` & `gordo-5.1.3/tests/gordo/workflow/test_workflow_generator/data/config-test-timestamp-3.yml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/workflow/test_workflow_generator/data/config-test-with-log-key.yml` & `gordo-5.1.3/tests/gordo/workflow/test_workflow_generator/data/config-test-with-log-key.yml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/workflow/test_workflow_generator/data/config-test-with-models.yml` & `gordo-5.1.3/tests/gordo/workflow/test_workflow_generator/data/config-test-with-models.yml`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/gordo/workflow/test_workflow_generator/test_workflow_generator.py` & `gordo-5.1.3/tests/gordo/workflow/test_workflow_generator/test_workflow_generator.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/test_examples.py` & `gordo-5.1.3/tests/test_examples.py`

 * *Files identical despite different names*

### Comparing `gordo-5.1.2/tests/utils.py` & `gordo-5.1.3/tests/utils.py`
