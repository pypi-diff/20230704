# Comparing `tmp/oidc_drf-1.2.5.tar.gz` & `tmp/oidc_drf-1.2.6.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "oidc_drf-1.2.5.tar", last modified: Tue Jul  4 10:10:52 2023, max compression
+gzip compressed data, was "oidc_drf-1.2.6.tar", last modified: Tue Jul  4 10:21:16 2023, max compression
```

## Comparing `oidc_drf-1.2.5.tar` & `oidc_drf-1.2.6.tar`

### file list

```diff
@@ -1,22 +1,22 @@
-drwxr-xr-x   0 hmogbl     (501) staff       (20)        0 2023-07-04 10:10:52.096051 oidc_drf-1.2.5/
--rw-r--r--   0 hmogbl     (501) staff       (20)     5978 2023-07-04 10:10:52.095921 oidc_drf-1.2.5/PKG-INFO
--rw-r--r--   0 hmogbl     (501) staff       (20)     5239 2023-07-04 08:38:47.000000 oidc_drf-1.2.5/README.md
-drwxr-xr-x   0 hmogbl     (501) staff       (20)        0 2023-07-04 10:10:52.094910 oidc_drf-1.2.5/oidc_drf/
--rw-r--r--   0 hmogbl     (501) staff       (20)        0 2023-06-21 18:35:48.000000 oidc_drf-1.2.5/oidc_drf/__init__.py
--rw-r--r--   0 hmogbl     (501) staff       (20)      578 2023-07-02 09:08:57.000000 oidc_drf-1.2.5/oidc_drf/admin.py
--rw-r--r--   0 hmogbl     (501) staff       (20)    15758 2023-07-03 09:52:34.000000 oidc_drf-1.2.5/oidc_drf/backends.py
--rw-r--r--   0 hmogbl     (501) staff       (20)     4583 2023-07-01 00:48:09.000000 oidc_drf-1.2.5/oidc_drf/drf.py
-drwxr-xr-x   0 hmogbl     (501) staff       (20)        0 2023-07-04 10:10:52.095767 oidc_drf-1.2.5/oidc_drf/migrations/
--rw-r--r--   0 hmogbl     (501) staff       (20)        0 2023-06-21 18:47:16.000000 oidc_drf-1.2.5/oidc_drf/migrations/__init__.py
--rw-r--r--   0 hmogbl     (501) staff       (20)      278 2023-07-02 09:08:51.000000 oidc_drf-1.2.5/oidc_drf/models.py
--rw-r--r--   0 hmogbl     (501) staff       (20)      507 2023-06-22 18:20:04.000000 oidc_drf-1.2.5/oidc_drf/urls.py
--rw-r--r--   0 hmogbl     (501) staff       (20)     2081 2023-06-21 07:35:29.000000 oidc_drf-1.2.5/oidc_drf/utils.py
--rw-r--r--   0 hmogbl     (501) staff       (20)     8170 2023-07-04 09:50:42.000000 oidc_drf-1.2.5/oidc_drf/views.py
-drwxr-xr-x   0 hmogbl     (501) staff       (20)        0 2023-07-04 10:10:52.095652 oidc_drf-1.2.5/oidc_drf.egg-info/
--rw-r--r--   0 hmogbl     (501) staff       (20)     5978 2023-07-04 10:10:52.000000 oidc_drf-1.2.5/oidc_drf.egg-info/PKG-INFO
--rw-r--r--   0 hmogbl     (501) staff       (20)      357 2023-07-04 10:10:52.000000 oidc_drf-1.2.5/oidc_drf.egg-info/SOURCES.txt
--rw-r--r--   0 hmogbl     (501) staff       (20)        1 2023-07-04 10:10:52.000000 oidc_drf-1.2.5/oidc_drf.egg-info/dependency_links.txt
--rw-r--r--   0 hmogbl     (501) staff       (20)       61 2023-07-04 10:10:52.000000 oidc_drf-1.2.5/oidc_drf.egg-info/requires.txt
--rw-r--r--   0 hmogbl     (501) staff       (20)        9 2023-07-04 10:10:52.000000 oidc_drf-1.2.5/oidc_drf.egg-info/top_level.txt
--rw-r--r--   0 hmogbl     (501) staff       (20)       38 2023-07-04 10:10:52.096083 oidc_drf-1.2.5/setup.cfg
--rw-r--r--   0 hmogbl     (501) staff       (20)     1118 2023-07-04 09:50:58.000000 oidc_drf-1.2.5/setup.py
...
### Comparing `oidc_drf-1.2.5/PKG-INFO` & `oidc_drf-1.2.6/PKG-INFO`
...
### Comparing `oidc_drf-1.2.5/README.md` & `oidc_drf-1.2.6/README.md`

 * *Files identical despite different names*

### Comparing `oidc_drf-1.2.5/oidc_drf/admin.py` & `oidc_drf-1.2.6/oidc_drf/admin.py`

 * *Files identical despite different names*

### Comparing `oidc_drf-1.2.5/oidc_drf/backends.py` & `oidc_drf-1.2.6/oidc_drf/backends.py`

 * *Files identical despite different names*

### Comparing `oidc_drf-1.2.5/oidc_drf/drf.py` & `oidc_drf-1.2.6/oidc_drf/drf.py`

 * *Files identical despite different names*

### Comparing `oidc_drf-1.2.5/oidc_drf/utils.py` & `oidc_drf-1.2.6/oidc_drf/utils.py`

 * *Files identical despite different names*

### Comparing `oidc_drf-1.2.5/oidc_drf/views.py` & `oidc_drf-1.2.6/oidc_drf/views.py`
...
### Comparing `oidc_drf-1.2.5/oidc_drf.egg-info/PKG-INFO` & `oidc_drf-1.2.6/oidc_drf.egg-info/PKG-INFO`
...
### Comparing `oidc_drf-1.2.5/setup.py` & `oidc_drf-1.2.6/setup.py`
