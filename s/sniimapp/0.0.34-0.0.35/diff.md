# Comparing `tmp/sniimapp-0.0.34.tar.gz` & `tmp/sniimapp-0.0.35.tar.gz`
...
## Comparing `sniimapp-0.0.34.tar` & `sniimapp-0.0.35.tar`
...
### Comparing `sniimapp-0.0.34/LICENSE` & `sniimapp-0.0.35/LICENSE`

 * *Files identical despite different names*

### Comparing `sniimapp-0.0.34/PKG-INFO` & `sniimapp-0.0.35/PKG-INFO`
...
### Comparing `sniimapp-0.0.34/README.md` & `sniimapp-0.0.35/README.md`

 * *Files identical despite different names*

### Comparing `sniimapp-0.0.34/pyproject.toml` & `sniimapp-0.0.35/pyproject.toml`
...
### Comparing `sniimapp-0.0.34/sniimapp.egg-info/PKG-INFO` & `sniimapp-0.0.35/sniimapp.egg-info/PKG-INFO`
...
### Comparing `sniimapp-0.0.34/sniimapp.py` & `sniimapp-0.0.35/sniimapp.py`
