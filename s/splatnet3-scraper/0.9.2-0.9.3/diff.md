# Comparing `tmp/splatnet3_scraper-0.9.2.tar.gz` & `tmp/splatnet3_scraper-0.9.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "splatnet3_scraper-0.9.2.tar", max compression
+gzip compressed data, was "splatnet3_scraper-0.9.3.tar", max compression
```

## Comparing `splatnet3_scraper-0.9.2.tar` & `splatnet3_scraper-0.9.3.tar`

### file list

```diff
@@ -1,22 +1,22 @@
--rw-r--r--   0        0        0    34915 2023-04-10 05:10:54.759478 splatnet3_scraper-0.9.2/LICENSE.md
--rw-r--r--   0        0        0    10984 2023-04-15 00:47:42.245111 splatnet3_scraper-0.9.2/README.md
--rw-r--r--   0        0        0     1916 2023-07-03 21:40:18.968201 splatnet3_scraper-0.9.2/pyproject.toml
--rw-r--r--   0        0        0       22 2023-07-03 21:40:18.968201 splatnet3_scraper-0.9.2/splatnet3_scraper/__init__.py
--rw-r--r--   0        0        0      271 2023-04-10 05:20:16.704543 splatnet3_scraper-0.9.2/splatnet3_scraper/auth/__init__.py
--rw-r--r--   0        0        0     3064 2023-04-10 05:20:16.704543 splatnet3_scraper-0.9.2/splatnet3_scraper/auth/environment_manager.py
--rw-r--r--   0        0        0      287 2023-04-10 05:10:54.769478 splatnet3_scraper-0.9.2/splatnet3_scraper/auth/exceptions.py
--rw-r--r--   0        0        0    10032 2023-04-14 23:55:14.106500 splatnet3_scraper-0.9.2/splatnet3_scraper/auth/graph_ql_queries.py
--rw-r--r--   0        0        0    44201 2023-07-03 19:28:53.887475 splatnet3_scraper-0.9.2/splatnet3_scraper/auth/nso.py
--rw-r--r--   0        0        0    31005 2023-07-03 21:28:37.215022 splatnet3_scraper-0.9.2/splatnet3_scraper/auth/token_manager.py
--rw-r--r--   0        0        0     7847 2023-05-26 03:02:35.840997 splatnet3_scraper-0.9.2/splatnet3_scraper/constants.py
--rw-r--r--   0        0        0      226 2023-04-10 05:20:16.704543 splatnet3_scraper-0.9.2/splatnet3_scraper/query/__init__.py
--rw-r--r--   0        0        0    13361 2023-07-03 21:40:18.968201 splatnet3_scraper-0.9.2/splatnet3_scraper/query/config.py
--rw-r--r--   0        0        0    19577 2023-07-03 21:28:18.895022 splatnet3_scraper-0.9.2/splatnet3_scraper/query/handler.py
--rw-r--r--   0        0        0    16980 2023-04-10 05:10:54.769478 splatnet3_scraper-0.9.2/splatnet3_scraper/query/json_parser.py
--rw-r--r--   0        0        0    27320 2023-07-02 23:51:51.516981 splatnet3_scraper-0.9.2/splatnet3_scraper/query/responses.py
--rw-r--r--   0        0        0      117 2023-04-10 05:10:54.769478 splatnet3_scraper-0.9.2/splatnet3_scraper/scraper/__init__.py
--rw-r--r--   0        0        0    10930 2023-07-03 19:28:53.887475 splatnet3_scraper-0.9.2/splatnet3_scraper/scraper/main.py
--rw-r--r--   0        0        0     6182 2023-04-14 04:47:23.115079 splatnet3_scraper-0.9.2/splatnet3_scraper/scraper/query_map.py
--rw-r--r--   0        0        0    18732 2023-07-03 05:07:37.608933 splatnet3_scraper-0.9.2/splatnet3_scraper/utils.py
--rw-r--r--   0        0        0    12156 1970-01-01 00:00:00.000000 splatnet3_scraper-0.9.2/setup.py
--rw-r--r--   0        0        0    11882 1970-01-01 00:00:00.000000 splatnet3_scraper-0.9.2/PKG-INFO
...
### Comparing `splatnet3_scraper-0.9.2/LICENSE.md` & `splatnet3_scraper-0.9.3/LICENSE.md`

 * *Files identical despite different names*

### Comparing `splatnet3_scraper-0.9.2/README.md` & `splatnet3_scraper-0.9.3/README.md`

 * *Files identical despite different names*

### Comparing `splatnet3_scraper-0.9.2/pyproject.toml` & `splatnet3_scraper-0.9.3/pyproject.toml`
...
### Comparing `splatnet3_scraper-0.9.2/splatnet3_scraper/auth/environment_manager.py` & `splatnet3_scraper-0.9.3/splatnet3_scraper/auth/environment_manager.py`

 * *Files identical despite different names*

### Comparing `splatnet3_scraper-0.9.2/splatnet3_scraper/auth/graph_ql_queries.py` & `splatnet3_scraper-0.9.3/splatnet3_scraper/auth/graph_ql_queries.py`

 * *Files identical despite different names*

### Comparing `splatnet3_scraper-0.9.2/splatnet3_scraper/auth/nso.py` & `splatnet3_scraper-0.9.3/splatnet3_scraper/auth/nso.py`

 * *Files identical despite different names*

### Comparing `splatnet3_scraper-0.9.2/splatnet3_scraper/auth/token_manager.py` & `splatnet3_scraper-0.9.3/splatnet3_scraper/auth/token_manager.py`

 * *Files identical despite different names*

### Comparing `splatnet3_scraper-0.9.2/splatnet3_scraper/constants.py` & `splatnet3_scraper-0.9.3/splatnet3_scraper/constants.py`

 * *Files identical despite different names*

### Comparing `splatnet3_scraper-0.9.2/splatnet3_scraper/query/config.py` & `splatnet3_scraper-0.9.3/splatnet3_scraper/query/config.py`
...
### Comparing `splatnet3_scraper-0.9.2/splatnet3_scraper/query/handler.py` & `splatnet3_scraper-0.9.3/splatnet3_scraper/query/handler.py`

 * *Files identical despite different names*

### Comparing `splatnet3_scraper-0.9.2/splatnet3_scraper/query/json_parser.py` & `splatnet3_scraper-0.9.3/splatnet3_scraper/query/json_parser.py`

 * *Files identical despite different names*

### Comparing `splatnet3_scraper-0.9.2/splatnet3_scraper/query/responses.py` & `splatnet3_scraper-0.9.3/splatnet3_scraper/query/responses.py`

 * *Files identical despite different names*

### Comparing `splatnet3_scraper-0.9.2/splatnet3_scraper/scraper/main.py` & `splatnet3_scraper-0.9.3/splatnet3_scraper/scraper/main.py`

 * *Files identical despite different names*

### Comparing `splatnet3_scraper-0.9.2/splatnet3_scraper/scraper/query_map.py` & `splatnet3_scraper-0.9.3/splatnet3_scraper/scraper/query_map.py`

 * *Files identical despite different names*

### Comparing `splatnet3_scraper-0.9.2/splatnet3_scraper/utils.py` & `splatnet3_scraper-0.9.3/splatnet3_scraper/utils.py`

 * *Files identical despite different names*

### Comparing `splatnet3_scraper-0.9.2/setup.py` & `splatnet3_scraper-0.9.3/setup.py`
...
### Comparing `splatnet3_scraper-0.9.2/PKG-INFO` & `splatnet3_scraper-0.9.3/PKG-INFO`
