# Comparing `tmp/syrupy-4.0.4.tar.gz` & `tmp/syrupy-4.0.5.tar.gz`
...
## Comparing `syrupy-4.0.4.tar` & `syrupy-4.0.5.tar`
...
### Comparing `syrupy-4.0.4/LICENSE` & `syrupy-4.0.5/LICENSE`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.4/README.md` & `syrupy-4.0.5/README.md`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.4/pyproject.toml` & `syrupy-4.0.5/pyproject.toml`
...
### Comparing `syrupy-4.0.4/src/syrupy/__init__.py` & `syrupy-4.0.5/src/syrupy/__init__.py`
...
### Comparing `syrupy-4.0.4/src/syrupy/assertion.py` & `syrupy-4.0.5/src/syrupy/assertion.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.4/src/syrupy/data.py` & `syrupy-4.0.5/src/syrupy/data.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.4/src/syrupy/exceptions.py` & `syrupy-4.0.5/src/syrupy/exceptions.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.4/src/syrupy/extensions/amber/__init__.py` & `syrupy-4.0.5/src/syrupy/extensions/amber/__init__.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.4/src/syrupy/extensions/amber/serializer.py` & `syrupy-4.0.5/src/syrupy/extensions/amber/serializer.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.4/src/syrupy/extensions/base.py` & `syrupy-4.0.5/src/syrupy/extensions/base.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.4/src/syrupy/extensions/image.py` & `syrupy-4.0.5/src/syrupy/extensions/image.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.4/src/syrupy/extensions/json/__init__.py` & `syrupy-4.0.5/src/syrupy/extensions/json/__init__.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.4/src/syrupy/extensions/single_file.py` & `syrupy-4.0.5/src/syrupy/extensions/single_file.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.4/src/syrupy/filters.py` & `syrupy-4.0.5/src/syrupy/filters.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.4/src/syrupy/location.py` & `syrupy-4.0.5/src/syrupy/location.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.4/src/syrupy/matchers.py` & `syrupy-4.0.5/src/syrupy/matchers.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.4/src/syrupy/report.py` & `syrupy-4.0.5/src/syrupy/report.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.4/src/syrupy/session.py` & `syrupy-4.0.5/src/syrupy/session.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.4/src/syrupy/terminal.py` & `syrupy-4.0.5/src/syrupy/terminal.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.4/src/syrupy/types.py` & `syrupy-4.0.5/src/syrupy/types.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.4/src/syrupy/utils.py` & `syrupy-4.0.5/src/syrupy/utils.py`

 * *Files identical despite different names*

### Comparing `syrupy-4.0.4/setup.py` & `syrupy-4.0.5/setup.py`
...
### Comparing `syrupy-4.0.4/PKG-INFO` & `syrupy-4.0.5/PKG-INFO`
