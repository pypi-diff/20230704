# Comparing `tmp/agixt-1.3.1.tar.gz` & `tmp/agixt-1.3.2.tar.gz`
...
### Comparing `agixt-1.3.1/docs/3-Providers/HuggingChat.md` & `agixt-1.3.2/docs/3-Providers/HuggingChat.md`
