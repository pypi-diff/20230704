# Comparing `tmp/asp_chef_cli-0.1.6.tar.gz` & `tmp/asp_chef_cli-0.1.7.tar.gz`
...
## Comparing `asp_chef_cli-0.1.6.tar` & `asp_chef_cli-0.1.7.tar`
...
### Comparing `asp_chef_cli-0.1.6/LICENSE` & `asp_chef_cli-0.1.7/LICENSE`

 * *Files identical despite different names*

### Comparing `asp_chef_cli-0.1.6/README.md` & `asp_chef_cli-0.1.7/README.md`

 * *Files identical despite different names*

### Comparing `asp_chef_cli-0.1.6/asp_chef_cli/cli.py` & `asp_chef_cli-0.1.7/asp_chef_cli/cli.py`

 * *Files identical despite different names*

### Comparing `asp_chef_cli-0.1.6/setup.py` & `asp_chef_cli-0.1.7/setup.py`
...
### Comparing `asp_chef_cli-0.1.6/PKG-INFO` & `asp_chef_cli-0.1.7/PKG-INFO`
