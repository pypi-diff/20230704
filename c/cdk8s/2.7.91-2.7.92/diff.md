# Comparing `tmp/cdk8s-2.7.91.tar.gz` & `tmp/cdk8s-2.7.92.tar.gz`
...
## Comparing `cdk8s-2.7.91.tar` & `cdk8s-2.7.92.tar`
...
### Comparing `cdk8s-2.7.91/LICENSE` & `cdk8s-2.7.92/LICENSE`

 * *Files identical despite different names*

### Comparing `cdk8s-2.7.91/PKG-INFO` & `cdk8s-2.7.92/PKG-INFO`
...
### Comparing `cdk8s-2.7.91/README.md` & `cdk8s-2.7.92/README.md`

 * *Files identical despite different names*

### Comparing `cdk8s-2.7.91/setup.py` & `cdk8s-2.7.92/setup.py`
...
### Comparing `cdk8s-2.7.91/src/cdk8s/__init__.py` & `cdk8s-2.7.92/src/cdk8s/__init__.py`

 * *Files identical despite different names*

### Comparing `cdk8s-2.7.91/src/cdk8s.egg-info/PKG-INFO` & `cdk8s-2.7.92/src/cdk8s.egg-info/PKG-INFO`
