# Comparing `tmp/LIFEsim-0.2.26.tar.gz` & `tmp/LIFEsim-0.2.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "/Users/fdannert/Documents/projects/LIFEsim/LIFEsim/dist/.tmp-8a9dl_1c/LIFEsim-0.2.26.tar", last modified: Tue Jul  4 15:33:54 2023, max compression
...
## Comparing `LIFEsim-0.2.26.tar` & `LIFEsim-0.2.9.tar`

### file list

```diff
@@ -1,38 +1,39 @@
-drwxr-xr-x   0 fdannert   (501) staff       (20)        0 2023-07-04 15:33:54.058757 LIFEsim-0.2.26/
--rw-r--r--   0 fdannert   (501) staff       (20)    35149 2023-05-17 12:44:11.000000 LIFEsim-0.2.26/LICENSE
-drwxr-xr-x   0 fdannert   (501) staff       (20)        0 2023-07-04 15:33:54.033409 LIFEsim-0.2.26/LIFEsim.egg-info/
--rw-r--r--   0 fdannert   (501) staff       (20)     1844 2023-07-04 15:33:54.000000 LIFEsim-0.2.26/LIFEsim.egg-info/PKG-INFO
--rw-r--r--   0 fdannert   (501) staff       (20)      718 2023-07-04 15:33:54.000000 LIFEsim-0.2.26/LIFEsim.egg-info/SOURCES.txt
--rw-r--r--   0 fdannert   (501) staff       (20)        1 2023-07-04 15:33:54.000000 LIFEsim-0.2.26/LIFEsim.egg-info/dependency_links.txt
--rw-r--r--   0 fdannert   (501) staff       (20)        1 2021-07-02 07:45:53.000000 LIFEsim-0.2.26/LIFEsim.egg-info/not-zip-safe
--rw-r--r--   0 fdannert   (501) staff       (20)      102 2023-07-04 15:33:54.000000 LIFEsim-0.2.26/LIFEsim.egg-info/requires.txt
--rw-r--r--   0 fdannert   (501) staff       (20)        8 2023-07-04 15:33:54.000000 LIFEsim-0.2.26/LIFEsim.egg-info/top_level.txt
--rw-r--r--   0 fdannert   (501) staff       (20)     1844 2023-07-04 15:33:54.058265 LIFEsim-0.2.26/PKG-INFO
--rw-r--r--   0 fdannert   (501) staff       (20)     1088 2023-05-17 12:44:11.000000 LIFEsim-0.2.26/README.rst
-drwxr-xr-x   0 fdannert   (501) staff       (20)        0 2023-07-04 15:33:54.034565 LIFEsim-0.2.26/lifesim/
--rw-r--r--   0 fdannert   (501) staff       (20)      549 2023-07-04 14:04:57.000000 LIFEsim-0.2.26/lifesim/__init__.py
-drwxr-xr-x   0 fdannert   (501) staff       (20)        0 2023-07-04 15:33:54.038389 LIFEsim-0.2.26/lifesim/core/
--rw-r--r--   0 fdannert   (501) staff       (20)    18831 2023-07-04 14:04:57.000000 LIFEsim-0.2.26/lifesim/core/core.py
--rw-r--r--   0 fdannert   (501) staff       (20)    26049 2023-07-04 14:04:57.000000 LIFEsim-0.2.26/lifesim/core/data.py
--rw-r--r--   0 fdannert   (501) staff       (20)     7152 2023-07-04 13:30:01.000000 LIFEsim-0.2.26/lifesim/core/modules.py
-drwxr-xr-x   0 fdannert   (501) staff       (20)        0 2023-07-04 15:33:54.041183 LIFEsim-0.2.26/lifesim/gui/
--rw-r--r--   0 fdannert   (501) staff       (20)     5346 2023-05-17 12:44:11.000000 LIFEsim-0.2.26/lifesim/gui/custom_widgets.py
--rw-r--r--   0 fdannert   (501) staff       (20)    34726 2023-05-17 12:44:11.000000 LIFEsim-0.2.26/lifesim/gui/spectrum_gui.py
-drwxr-xr-x   0 fdannert   (501) staff       (20)        0 2023-07-04 15:33:54.047229 LIFEsim-0.2.26/lifesim/instrument/
--rw-r--r--   0 fdannert   (501) staff       (20)    39239 2023-07-04 14:04:57.000000 LIFEsim-0.2.26/lifesim/instrument/instrument.py
--rw-r--r--   0 fdannert   (501) staff       (20)     5637 2023-07-04 13:30:01.000000 LIFEsim-0.2.26/lifesim/instrument/pn_exozodi.py
--rw-r--r--   0 fdannert   (501) staff       (20)     5253 2023-07-04 13:30:01.000000 LIFEsim-0.2.26/lifesim/instrument/pn_localzodi.py
--rw-r--r--   0 fdannert   (501) staff       (20)     4442 2023-07-04 13:30:01.000000 LIFEsim-0.2.26/lifesim/instrument/pn_star.py
--rw-r--r--   0 fdannert   (501) staff       (20)     9546 2023-07-04 13:30:01.000000 LIFEsim-0.2.26/lifesim/instrument/transmission.py
-drwxr-xr-x   0 fdannert   (501) staff       (20)        0 2023-07-04 15:33:54.049991 LIFEsim-0.2.26/lifesim/optimize/
--rw-r--r--   0 fdannert   (501) staff       (20)     7006 2023-07-04 13:30:01.000000 LIFEsim-0.2.26/lifesim/optimize/ahgs.py
--rw-r--r--   0 fdannert   (501) staff       (20)     4196 2023-07-04 13:30:01.000000 LIFEsim-0.2.26/lifesim/optimize/optimizer.py
-drwxr-xr-x   0 fdannert   (501) staff       (20)        0 2023-07-04 15:33:54.057027 LIFEsim-0.2.26/lifesim/util/
--rw-r--r--   0 fdannert   (501) staff       (20)      181 2023-05-17 12:44:11.000000 LIFEsim-0.2.26/lifesim/util/constants.py
--rw-r--r--   0 fdannert   (501) staff       (20)     2702 2023-05-17 12:44:11.000000 LIFEsim-0.2.26/lifesim/util/habitable.py
--rw-r--r--   0 fdannert   (501) staff       (20)     6088 2023-05-17 12:44:11.000000 LIFEsim-0.2.26/lifesim/util/importer.py
--rw-r--r--   0 fdannert   (501) staff       (20)     7306 2023-07-04 14:04:57.000000 LIFEsim-0.2.26/lifesim/util/options.py
--rw-r--r--   0 fdannert   (501) staff       (20)     5734 2021-07-02 07:44:41.000000 LIFEsim-0.2.26/lifesim/util/radiation.py
--rw-r--r--   0 fdannert   (501) staff       (20)      103 2023-05-17 12:44:11.000000 LIFEsim-0.2.26/pyproject.toml
--rw-r--r--   0 fdannert   (501) staff       (20)       38 2023-07-04 15:33:54.058963 LIFEsim-0.2.26/setup.cfg
--rw-r--r--   0 fdannert   (501) staff       (20)     2040 2023-07-04 14:04:57.000000 LIFEsim-0.2.26/setup.py
...
### Comparing `LIFEsim-0.2.26/LICENSE` & `LIFEsim-0.2.9/LICENSE`

 * *Files identical despite different names*

### Comparing `LIFEsim-0.2.26/LIFEsim.egg-info/PKG-INFO` & `LIFEsim-0.2.9/LIFEsim.egg-info/PKG-INFO`
...
### Comparing `LIFEsim-0.2.26/LIFEsim.egg-info/SOURCES.txt` & `LIFEsim-0.2.9/LIFEsim.egg-info/SOURCES.txt`
...
### Comparing `LIFEsim-0.2.26/PKG-INFO` & `LIFEsim-0.2.9/PKG-INFO`
...
### Comparing `LIFEsim-0.2.26/README.rst` & `LIFEsim-0.2.9/README.rst`
...
### Comparing `LIFEsim-0.2.26/lifesim/__init__.py` & `LIFEsim-0.2.9/lifesim/__init__.py`
...
### Comparing `LIFEsim-0.2.26/lifesim/core/core.py` & `LIFEsim-0.2.9/lifesim/core/core.py`
...
### Comparing `LIFEsim-0.2.26/lifesim/core/data.py` & `LIFEsim-0.2.9/lifesim/core/data.py`
...
### Comparing `LIFEsim-0.2.26/lifesim/core/modules.py` & `LIFEsim-0.2.9/lifesim/core/modules.py`
...
### Comparing `LIFEsim-0.2.26/lifesim/gui/custom_widgets.py` & `LIFEsim-0.2.9/lifesim/gui/custom_widgets.py`
...
### Comparing `LIFEsim-0.2.26/lifesim/gui/spectrum_gui.py` & `LIFEsim-0.2.9/lifesim/gui/spectrum_gui.py`
...
### Comparing `LIFEsim-0.2.26/lifesim/instrument/pn_exozodi.py` & `LIFEsim-0.2.9/lifesim/instrument/pn_exozodi.py`
...
### Comparing `LIFEsim-0.2.26/lifesim/instrument/pn_localzodi.py` & `LIFEsim-0.2.9/lifesim/instrument/pn_localzodi.py`
...
### Comparing `LIFEsim-0.2.26/lifesim/instrument/pn_star.py` & `LIFEsim-0.2.9/lifesim/instrument/pn_star.py`
...
### Comparing `LIFEsim-0.2.26/lifesim/instrument/transmission.py` & `LIFEsim-0.2.9/lifesim/instrument/transmission.py`

 * *Files identical despite different names*

### Comparing `LIFEsim-0.2.26/lifesim/optimize/ahgs.py` & `LIFEsim-0.2.9/lifesim/optimize/ahgs.py`
...
### Comparing `LIFEsim-0.2.26/lifesim/optimize/optimizer.py` & `LIFEsim-0.2.9/lifesim/optimize/optimizer.py`
...
### Comparing `LIFEsim-0.2.26/lifesim/util/habitable.py` & `LIFEsim-0.2.9/lifesim/util/habitable.py`
...
### Comparing `LIFEsim-0.2.26/lifesim/util/importer.py` & `LIFEsim-0.2.9/lifesim/util/importer.py`
...
### Comparing `LIFEsim-0.2.26/lifesim/util/options.py` & `LIFEsim-0.2.9/lifesim/util/options.py`
...
### Comparing `LIFEsim-0.2.26/lifesim/util/radiation.py` & `LIFEsim-0.2.9/lifesim/util/radiation.py`
